                                ...
                                <form enctype="multipart/form-data" method="post">
                                    <div class="flex justify-center items-center mb-4">
                                        <button
                                            ...
                                            <svg class="w-4 h-4 fill-current text-gray-900"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                <path
                                                    d="M19 13H13v6c0 .6-.4 1-1 1s-1-.4-1-1v-6H5c-.6 0-1-.4-1-1s.4-1 1-1h6V5c0-.6.4-1 1-1s1 .4 1 1v6h6c.6 0 1 .4 1 1s-.4 1-1 1z" />
                                            </svg>
                                        </button>
                                        ...
                                        <button
                                            ...
                                            <svg class="w-4 h-4 text-gray-900" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M15 9a1 1 0 010 2H5a1 1 0 110-2h10z"
                                                    clip-rule="evenodd" />
                                            </svg>
                                        </button>
                                        <button
