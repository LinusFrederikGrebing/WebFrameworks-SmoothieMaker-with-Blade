...
{  
    ...
    // establishes a many-to-many relationship between the current model and the Ingredient model through the preset_ingredients table. 
    ...
    {
        return $this->belongsToMany(Ingredient::class, 'preset_ingredients')->withPivot('quantity');
    }
